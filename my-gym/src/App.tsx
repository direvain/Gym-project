...
<div>
      <Routes>
        ...
        <Route path="/PlayerQrcode" element={<PlayerQrcodeInfo value="direvain123123123123123" name="عبدالرحمن ابراهيم جمعه حبوش" startDate="2024/12/3"  endDate="2025/9/3" age="20" weight="80" phoneNumber="0777211590" downloadName="`${name}`" onDownloadComplete={() => { /* Callback logic here */ }} />}/>
      </Routes>
    </div>
  );
}
